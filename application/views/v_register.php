      ...
      <section class="ftco-section ">
        <div class="container">
          ...
          <?php if ($this->session->flashdata('error')) {?>
              ...
              <?php }?>
                <form method ="post" action="<?php echo base_url('login/tambah_register');?>" class=" p-3 p-md-5 bg-light">
                   <h3>Register</h3> 
                ...
                <div class="form-group">
                  <button type="submit"  name="login" class="btn btn-secondary btn-lg btn-block">Register</button> </div>
